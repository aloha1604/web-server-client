                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-3 col-md-3 col-sm-6">
                            <a className="product" href="#/tp-ho-chi-minh-huyen-binh-chanh/mua-ban-nha-dat-nha-trong-ngo/ban-nha-3-phong-ngu-tang-noi-that-cao-cap-gia-hap-dan-o-binh-chanh-2292713.html">
                                <div className="thumb"><img src="https://imgraovat.vnecdn.net/images/300_180/2020/07/01/e0c0fe0eda2a297d3ec8279a55e979de.jpeg" className="img-fluid img-thumbnail" alt="description of image" aria-hidden="true" />
                                </div>
                                <ul className="info clearfix">
                                    <li>
                        ...
                        <div className="col-lg-3 col-md-3 col-sm-6">
                            <a className="product" href="#/tp-ho-chi-minh-quan-tan-binh/thue-nha-dat-can-ho-chung-cu/don-gia-hoan-thien-can-ho-1803691.html">
                                <div className="thumb"><img src="https://imgraovat.vnecdn.net/images/300_180/2017/11/23/c9224ecfc7b525fc174f45884eafc969.jpeg" className="img-fluid img-thumbnail" alt="description of image" aria-hidden="true" />
                                </div>
                                <ul className="info clearfix">
                                    <li>
                        ...
                        <div className="col-lg-3 col-md-3 col-sm-6">
                            <a className="product" href="#/tp-ho-chi-minh-quan-3/thue-nha-dat-van-phong/cho-thue-mat-bang-van-phong-duong-30m-q3-gia-22tr-2293137.html">
                                <div className="thumb"><img src="https://imgraovat.vnecdn.net/images/300_180/2020/07/01/112f522df232401c6f0a45a8742f44a5.jpeg" className="img-fluid img-thumbnail" alt="description of image" aria-hidden="true" />
                                </div>
                                <ul className="info clearfix">
                                    <li>
                        ...
                        <div className="col-lg-3 col-md-3 col-sm-6">
                            <a className="product" href="#/tp-ho-chi-minh-quan-binh-tan/mua-ban-nha-dat-dat-nen-du-an/ngan-hang-thanh-ly-16-nen-dat-va-3-lo-goc-lien-ke-khu-ten-lua-binh-tan-2272662.html">
                                <div className="thumb"><img src="https://imgraovat.vnecdn.net/images/300_180/2020/06/16/ff59002fa8a8ff780a70fd9986029b91.jpeg" className="img-fluid img-thumbnail" alt="dohem" aria-hidden="true" />
                                </div>
                                <ul className="info clearfix">
                                    <li>
                        ...
                        <div className="col-lg-3 col-md-3 col-sm-6">
                            <a className="product" href="#/tp-ho-chi-minh/oto-ban/isuzu-mu-x-so-san-may-dau-1-9-nhap-khau-thai-lan-2293124.html">
                                <div className="thumb"><img src="https://imgraovat.vnecdn.net/images/300_180/2020/07/01/1bcd3c014af1220cc8a28fb655832cae.jpeg" className="img-fluid img-thumbnail" alt="description of image" />
                                </div>
                                <ul className="info clearfix">
                                    <li>
                        ...
                        <div className="col-lg-3 col-md-3 col-sm-6">
                            <a className="product" href="#/tp-ho-chi-minh-quan-7/mua-ban-nha-dat-can-ho-chung-cu/chung-cu-an-vien-02-pn-02-wc-73m2-khu-nam-long-a-0174-2292927.html">
                                <div className="thumb"><img src="https://imgraovat.vnecdn.net/images/300_180/2020/07/01/aa55576f57309dd285ea4ae289fca3f9.jpeg" className="img-fluid img-thumbnail" alt="description of image" />
                                </div>
                                <ul className="info clearfix">
                                    <li>
                        ...
                        <div className="col-lg-3 col-md-3 col-sm-6">
                            <a className="product" href="/tp-ho-chi-minh-quan-binh-tan/mua-ban-nha-dat-dat-nen-du-an/dat-tho-cu-mat-tien-duong-huong-lo-2-voi-gia-30-trieu-m2-co-so-2292906.html">
                                <div className="thumb"><img src="https://imgraovat.vnecdn.net/images/300_180/2020/07/01/19581e0003efecf1eeb942d9ead0e37b.jpeg" className="img-fluid img-thumbnail" alt="description of image" />
                                </div>
                                <ul className="info clearfix">
                                    <li>
                        ...
                        <div className="col-lg-3 col-md-3 col-sm-6">
                            <a className="product" href="#/tp-ho-chi-minh-quan-binh-tan/mua-ban-nha-dat-dat-nen-du-an/ho-tro-ngan-hang-thanh-ly-15-nen-dat-re-hon-thi-truong-15-gan-bx-mien-2292690.html">
                                <div className="thumb"><img src="https://imgraovat.vnecdn.net/images/300_180/2020/07/01/052e6e91498dd1f26da9450612ea3ec6.jpeg" className="img-fluid img-thumbnail" alt="description of image" />
                                </div>
                                <ul className="info clearfix">
                                    <li>
                        ...
                        <div className="col-lg-3 col-md-3 col-sm-6">
                            <a className="product" href="#/tp-ho-chi-minh-quan-9/mua-ban-nha-dat-dat-nen-du-an/dat-bung-ong-thoan-2265248.html">
                                <div className="thumb"><img src="https://imgraovat.vnecdn.net/images/300_180/2020/05/21/132f52cdef373b9d05e323f5e33732fc.jpeg" className="img-fluid img-thumbnail" alt="description of image" />
                                </div>
                                <ul className="info clearfix">
                                    <li>
